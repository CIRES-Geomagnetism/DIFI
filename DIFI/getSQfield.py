...
def vectorized_getSQfield(lat: Union[float, list], lon: Union[float, list], year: Union[int, list], month: Union[int, list], day: Union[int, list], hour: Union[int, list]=0, minutes: Union[int, list]=0, h: Union[int, list]=0, f107_1: Optional[list]=None) -> dict:
    """
    Input:
        Latitude, lat (in WGS-84 coordinates)
        Longtitude, lon
