...
def design_SHA_Sq_e_Re_v2(rho: Union[float, np.ndarray], theta: Union[float, np.ndarray], phi: Union[float, np.ndarray], nmax: int, mmax:int) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
